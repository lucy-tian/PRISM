...
trait = pd.read_csv('FEV1_FVC ratio.groupings.tsv', sep='\t')

# get lung-related columns from chr1 first
...
def compute_or_ABC_vs_D(df, annot_col='ccre'):
...
binary_or.to_csv(f'{out_d}/FEV1_FVC_ratio_table.tsv', sep='\t', index=False)