...
in_dir  <- "prs"
eur_prs <- file.path(in_dir, paste0("WB_exclude_APOE",  trait, ".score.txt"))  # WB/EUR PRS on AFR-val+test
afr_prs <- file.path(in_dir, paste0("Afr_exclude_APOE", trait, ".score.txt"))  # AFR PRS on same samples
...
# ---------- output ----------
out_dir   <- "prs"
outPrefix <- file.path(out_dir, paste0("tuned_afr_wb_exclude_APOE", trait))
